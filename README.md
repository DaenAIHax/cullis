...
curl -L https://github.com/cullis-security/cullis/releases/download/mastio-v0.6.3/cullis-mastio-bundle.tar.gz | tar xz
...
|---|---|---|
| **Cullis Mastio** | [`mastio-v0.6.3`](https://github.com/cullis-security/cullis/releases/tag/mastio-v0.6.3) | Org gateway, agent CA, Rego + allowlist policy engine, audit chain, MCP reverse proxy, embedded AI gateway, OPA Data API + CloudEvents bridge for external data planes |
